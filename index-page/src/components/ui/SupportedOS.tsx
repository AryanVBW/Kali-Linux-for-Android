...
import parrotLogo from "@/assets/parrot-os-logo.png";
            ...
            >
              <div className="relative h-48 overflow-hidden bg-muted/50 flex items-center justify-center p-4">
                <img
                  ...
                  style={{
                    filter: os.name === "Parrot OS" ? "brightness(0) saturate(100%) invert(70%) sepia(98%) saturate(2276%) hue-rotate(158deg) brightness(101%) contrast(101%)" : "brightness(0) dark:brightness(100) invert(0) dark:invert(0)"
                  }}
                  onError={(e) => {
